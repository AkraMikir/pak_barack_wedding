        ...
        <form id="loginForm" action="{{ route('admin.login.submit') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <button type="button" onclick="togglePasswordVisibility()" title="Tampilkan/Sembunyikan Password" tabindex="-1"
                            class="absolute right-2.5 top-1/2 -translate-y-1/2 text-stone-400 hover:text-stone-600 focus:outline-none p-1 pointer-events-auto">
                        <svg id="eyeIcon" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                            <circle cx="12" cy="12" r="3"></circle>
                        </svg>
                        <svg id="eyeOffIcon" class="w-4 h-4 hidden" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function checkLockout() {
            ...
            if (now < lockoutUntil) {
                ...
                err.textContent = `Terlalu banyak percobaan. Tidak dapat login selama ${remaining} detik.`;
